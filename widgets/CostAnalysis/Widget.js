  ...
  return declare([BaseWidget, _WidgetsInTemplateMixin], {
        ...
        lang.hitch(this, function (assetItemSummary) {
          if (this._assetStatistics) {
            ...
            setTimeout(lang.hitch(this, function () {
              ...
              appUtils.setFirstAndLastWBFocusNode(this.domNode, this._workBench.selectButton,
                lastNode);
            }), 0);
          }
        })));
    ...
    _initProjectAttribute: function (projectInfo) {
      ...
      if (!this._projectAttribute) {
        ...
        this.own(on(this._projectAttribute, "onOkButtonClicked", lang.hitch(this, function () {
          ...
          this._showPanel("workBench", true);
        })));
    ...
    */
    ...
    _openLastVisitedPanel: function (isWidgetOpened) {
      var getOpenedTitleName, paneName, getLastVisitedWorkBenchPanel, assetActionIcon,
      ...
      if (this._currentPanelName === "workBench") {
        ...
        if (this._previousOpenedPanel === "statisticsPanel") {
          assetActionIcon = query('.esriCTItemListImageLogo.esriCTAssetActionIcon', this.domNode)[0];
          focusUtils.focus(assetActionIcon);
        }
    ...
    _setFirstAndLastFocusNode: function () {
      ...
      if (this._currentPanelName === "workBench") {
        if (this._workBench) {
          jimuUtils.initFirstFocusNode(this.domNode, this._workBench.selectButton);
          focusUtils.focus(this._workBench.selectButton);
          if (domClass.contains(this._workBench.downloadCSVBtn, "esriCTHidden") ||
