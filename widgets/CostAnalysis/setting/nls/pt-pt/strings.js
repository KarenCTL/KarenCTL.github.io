...
define({
  ...
  "projectSettings": {
    ...
    "costingGeometryHelp": "<p>Camada(s) de poligono(s) com as seguintes condições serão exibidas: <br/> <li>\tA camada tem de ter funcionalidade de Consulta</li><li>\tA camada tem de ter um campo GlobalID</li></p>",
