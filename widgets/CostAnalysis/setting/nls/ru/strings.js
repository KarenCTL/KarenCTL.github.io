...
define({
  ...
  "projectSettings": {
    ...
    "costingGeometryHelp": "<p>Будут показаны полигональные слои со следующими условиями: <br/> <li>\tУ слоя должна быть возможность апроса</li><li>\tУ слоя должно быть поле GlobalID</li></p>",
