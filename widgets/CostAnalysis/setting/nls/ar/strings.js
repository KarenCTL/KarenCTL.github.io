...
define({
  ...
  "projectSettings": {
    ...
    "costingGeometryHelp": "<p>يتم عرض طبقات المضلع ذات الشروط التالية: <br/> <li>\tيجب أن تحتوي الطبقة على إمكانية الاستعلام </li><li>\tيجب أنت تحتوي الطبقة على حقل المعرف العالمي</li></p>",
