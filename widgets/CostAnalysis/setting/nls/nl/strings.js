...
define({
  ...
  "projectSettings": {
    ...
    "costingGeometryHelp": "<p>Vlaklaag (-lagen) met de volgende voorwaarden wordt getoond: <br/> <li>\tLaag moet Query-capaciteit hebben</li><li>\tLaag moet een GlobalID-veld hebben</li></p>",
