...
define({
  ...
  "projectSettings": {
    ...
    "costingGeometryHelp": "<p>Lớp đa giác có các điều kiện sau sẽ được hiển thị: <br/> <li>\tLớp phải có khả năng Truy vấn capability</li><li>\tLớp phải có trường GlobalID</li></p>",
