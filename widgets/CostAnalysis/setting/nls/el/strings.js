...
define({
  ...
  "projectSettings": {
    ...
    "costingGeometryHelp": "<p>Θα εμφανίζεται (εμφανίζονται) θεματικό(ά) επίπεδο(α) πολύγωνου με τις εξής συνθήκες: <br/> <li>\tΤο θεματικό επίπεδο πρέπει να έχει δυνατότητα Query</li><li>\tΤο θεματικό επίπεδο πρέπει να έχει ένα πεδίο GlobalID</li></p>",
