...
define({
  ...
  "projectSettings": {
    ...
    "costingGeometryHelp": "<p>ชั้นข้อมูลรูปหลายเหลี่ยมที่มีเงื่อนไขต่อไปนี้จะแสดงขึ้น: <br/> <li>\tชั้นข้อมูลต้องมีความสามารถ Query</li><li>\tชั้นข้อมูลต้องมีฟิลด์ GlobalID</li></p>",
