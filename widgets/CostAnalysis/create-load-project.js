  ...
  return declare([BaseWidget, Evented, _WidgetsInTemplateMixin], {
    ...
    _createButtonClicked: function (projectDescTextBox) {
      ...
      if (this.projectNameTextBox.isValid() && projectDescTextBox.isValid()) {
        ...
        this._validateForDuplicateProjectName(this.projectNameTextBox.get('value')).then(
          lang.hitch(this, function (duplicateProjectName) {
            ...
            if (!duplicateProjectName) {
              this._addProjectToLayer(this.projectNameTextBox.get('value'),
                projectDescTextBox.get('value')).then(lang.hitch(this, function (result) {
                  ...
                  if (result && result.success && result.globalId) {
                    ...
                    newlyAddedOption = {
                      label: this.projectNameTextBox.get('value'),
                    ...
                    this.emit("createProject", {
                      "name": this.projectNameTextBox.get('value'),
