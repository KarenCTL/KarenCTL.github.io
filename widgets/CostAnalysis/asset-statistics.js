  ...
  return declare([BaseWidget, Evented, _WidgetsInTemplateMixin], {
    ...
    */
    ...
    setFirstAndLastNode: function() {
      var noDetailStatisticsMsgArray;
      noDetailStatisticsMsgArray = query(".esriCTNoDetailStatisticMessage", this.widgetDomNode);
      if(noDetailStatisticsMsgArray.length) {
        jimuUtils.initFirstFocusNode(this.widgetDomNode, noDetailStatisticsMsgArray[0]);
        focusUtils.focus(noDetailStatisticsMsgArray[0]);
      }
      else {
        var detailStatisticsArray, firstDomEle;
        detailStatisticsArray = query(".esriCTAssetDetailTextBox", this.widgetDomNode);
        firstDomEle = registry.byNode(detailStatisticsArray[0]).textbox;
        jimuUtils.initFirstFocusNode(this.widgetDomNode, firstDomEle);
        focusUtils.focus(firstDomEle);
      }
