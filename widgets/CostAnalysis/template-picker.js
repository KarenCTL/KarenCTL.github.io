    ...
    _displayCopyAssetsPopup: function () {
      ...
      this.own(on(enabledButtons[0], "keydown", lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          ...
          jimuUtils.initFirstFocusNode(this.widgetDomNode, this.selectButton);
    ...
    */
    ...
    _createCopyFeaturesInstance: function () {
      ...
      this.own(on(this._copyFeaturesObj, "cancelBtnClicked", lang.hitch(this, function () {
        ...
        this.appUtils.setFirstAndLastWBFocusNode(this.widgetDomNode, this.selectButton, lastNode);
        focusUtils.focus(this.selectButton);
      })));
